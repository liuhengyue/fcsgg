"""
Analyzing tools for Detectron2 models.

Modified from https://github.com/facebookresearch/detectron2/blob/main/tools/analyze_model.py
"""
...
from fcsgg.utils.analysis import (
...
def do_flop(cfg):
    data_loader = build_detection_test_loader(cfg, cfg.DATASETS.TEST[0], mapper=DatasetMapper(cfg, False))
